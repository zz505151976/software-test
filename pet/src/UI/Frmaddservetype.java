...
public class Frmaddservetype extends JDialog implements ActionListener{
	...
	public Frmaddservetype(Frame f,String s,boolean b) {
		super(f,s,b);
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==btnno) {
			...
			try {
				PetUtil.serverManage.addservetype(id, name, des);
				this.setVisible(false);
